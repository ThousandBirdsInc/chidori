...
| [Deployment](./docs/deployment.md) | Running in production: the zero-dependency single-machine setup, managed hosts (Fly.io, Railway, Render), high availability, hardening, durability tiers |
