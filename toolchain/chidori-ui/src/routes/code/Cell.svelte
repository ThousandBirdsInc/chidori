<script lang="ts">
    import CodeComponent from './_CellTypes/Code.svelte';
    import PromptComponent from './_CellTypes/Prompt.svelte';
    import WebComponent from './_CellTypes/Web.svelte';
    import TemplateComponent from './_CellTypes/Template.svelte';
    export let item: any = {};
...
<div class="max-w-2xl p-6 bg-white rounded-lg border  flex flex-col gap-4">
    {JSON.stringify({opId, appliedAt, cell})}
