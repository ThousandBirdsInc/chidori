...
// Sadly, Ewald de Wit, author of https://github.com/erdewit/nest_asyncio, passed away March 11, 2024.
// This project is how Jupyter notebooks themselves handle nested asyncio event loops.
// In tribute to his work, we refer to the source for his library to patch asyncio here. We reproduce
// the code here for the purposes of directly maintaining an implementation of this work in the
// Chidori project.

pub fn get_module<'a>(py: Python<'a>) -> PyResult<&'a PyModule> {
    let code = r#"
...
"#;
    let nest_asyncio = PyModule::from_code(
        py,
        code,
        "nest_asyncio.py",
        "nest_asyncio",
